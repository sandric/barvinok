...
first_talk_comment_first = Comment.create(data: "## comment First talk first comment", talk: first_talk, user: user_second)
first_talk_comment_first = Comment.create(data: "** comment First talk second comment", talk: first_talk, user: user)
first_talk_comment_first = Comment.create(data: "# comment First talk third comment", talk: first_talk, user: user_second)
first_talk_comment_first = Comment.create(data: "## comment First talk first comment", talk: first_talk, user: user_second)
first_talk_comment_first = Comment.create(data: "** comment First talk second comment", talk: first_talk, user: user)
first_talk_comment_first = Comment.create(data: "# comment First talk third comment", talk: first_talk, user: user_second)
first_talk_comment_first = Comment.create(data: "## comment First talk first comment", talk: first_talk, user: user_second)
...
second_talk_comment_first = Comment.create(data: "second talk first comment", talk: second_talk, user: user_second)
second_talk_comment_first = Comment.create(data: "second talk second comment", talk: second_talk, user: user)
second_talk_comment_first = Comment.create(data: "second talk third comment", talk: second_talk, user: user_second)

third_talk_comment_first = Comment.create(data: "third talk first comment", talk: third_talk, user: user_second)
third_talk_comment_first = Comment.create(data: "third talk second comment", talk: third_talk, user: user)
third_talk_comment_first = Comment.create(data: "third talk third comment", talk: third_talk, user: user_second)

fourth_talk_comment_first = Comment.create(data: "fourth talk first comment", talk: fourth_talk, user: user_second)
fourth_talk_comment_first = Comment.create(data: "fourth talk second comment", talk: fourth_talk, user: user)
fourth_talk_comment_first = Comment.create(data: "fourth talk third comment", talk: fourth_talk, user: user_second)

fifth_talk_comment_first = Comment.create(data: "fifth talk first comment", talk: fifth_talk, user: user_second)
fifth_talk_comment_first = Comment.create(data: "fifth talk second comment", talk: fifth_talk, user: user)
fifth_talk_comment_first = Comment.create(data: "fifth talk third comment", talk: fifth_talk, user: user_second)